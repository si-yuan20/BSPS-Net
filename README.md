...
The corresponding **nnU-Net v2 plans**, training configurations, and necessary experiment metadata will also be provided to facilitate reproducibility.

---

## Planned Repository Structure

After the official release, the repository is expected to follow a structure similar to:
...
The final directory organization may be adjusted before the official release.
...
**Code + Configuration + Dataset Splits + Model Weights + Evaluation Scripts**
...
Major updates regarding code, model weights, dataset splits, and reproducibility materials will be announced through this repository.
